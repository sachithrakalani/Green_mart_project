<%-- 
    Document   : meat.jsp
    Created on : Dec 31, 2023, 9:28:48 PM
    Author     : user
--%>
            ...
            <div>
                <div id="navbar"> 
                    <ul>
                        ...
                        <li><a href="meat.jsp" class="active">Meat</a></li>
        ...
        <div class="items-view" style='padding:40px 80px;'>
            <%
                try {
                        ...
                        String str = "select  meat_id, meat_name,  meat_prices, meat_image_path from meat_details where meat_category = 1";
//                        out.println(str);
                        ...
                        while (rs.next()) {
                            ...
                            String itemId = rs.getString("meat_id");
                            //out.println(itemId);
...
//                            out.println("<i class='fa fa-star'></i>");
        ...
        <script>
            function redirectToItemDetails(itemId) {
                window.location.href = 'singleproductmeat.jsp?id=' + itemId;
            }
        </script>
    </body>
</html>
