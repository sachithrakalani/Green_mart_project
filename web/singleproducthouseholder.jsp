<%-- 
    Document   : singleproducthouseholder.jsp
    Created on : Dec 31, 2023, 9:14:21 PM
    Author     : user
--%>
    ...
    <body>
        ...
        <%
            try {
                ...
                String str = "select householder_id, householder_name, householder_prices, householder_des, householder_image_path from householder_details where householder_id = '" + itemId + "' ";
                ...
                while (rs.next()) {
                    ...
                    String itemDescription = rs.getString("householder_des");
