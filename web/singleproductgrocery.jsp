<%-- 
    Document   : singleproductgrocery.jsp
    Created on : Dec 31, 2023, 12:17:18 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Single Product Grocery Page</title>
    ...
    <body>
        ...
        <%
            try {
                ...
                String str = "select grocery_id, grocery_name, prices,item_des, image_path from grocery_details where grocery_id = '" + itemId + "' ";
